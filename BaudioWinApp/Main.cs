...
namespace BaudioWinApp
{
    public partial class Main : Form
    {
        ...
        private void dgvBookList_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
        ...
        {
            if (dgvBookList.CurrentRow == null) return;

            Listen listen= new Listen();

            listen.bookName = dgvBookList.CurrentRow.Cells[0].Value.ToString();
            listen.audioPath = dgvBookList.CurrentRow.Cells[1].Value.ToString();
            listen.addedDate = dgvBookList.CurrentRow.Cells[2].Value.ToString();
